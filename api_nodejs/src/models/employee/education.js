...
const createEmployeeEducationBulks = async (
    reqEducations = [],reqEmployeeID = null,
    tx = false, reqRequestID = null) => {
    ...
    for (const reqEducation of reqEducations) {
        valuesArray.push(
            reqEmployeeID,
            reqEducation.reqName,
            reqEducation.reqLevel,
            reqEducation.reqDescription,
            reqEducation.reqCreatedBy,
            reqEducation.reqCreatedBy
        );
    ...
    try {
        ...
        if (metadata === reqEducations.length) {
            content.data = {
        ...
        logger.error("Database Error (createEmployeeEducationBulks)", {
            request_id:reqRequestID,
            location:"models/employee/education.createEmployeeEducationBulks",
            method:"createEmployeeEducationBulks",
            error:{
                name: error.name,
                message: error.message,
                stack: error.stack
